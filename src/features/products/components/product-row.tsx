...
import { useToggleProductField, useDeleteProduct } from '../hooks/use-products';
  ...
  return (
    <>
      ...
      <ConfirmDeleteDialog
        ...
        description="هل أنت متأكد من حذف هذا المنتج؟ سيتم نقله لسلة المحذوفات."
        onConfirm={() => deleteMutation.mutate(product.uuid)}
