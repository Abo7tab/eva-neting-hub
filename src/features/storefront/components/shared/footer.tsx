...
export const Footer = () => {
  ...
  const about = settings['content_footer_about_ar'] || 'اكتشفي عالمك من الجمال مع إيفا نيتنج هاب. نحن نقدم لكِ أفضل وأجود منتجات العناية والتجميل بأسعار لا تقبل المنافسة وبضمان الجودة والأصالة.';
  const copyright = settings['copyright_text_ar'] || `© ${new Date().getFullYear()} إيفا نيتنج هاب. جميع الحقوق محفوظة.`;
